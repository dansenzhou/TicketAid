package de.tum.in.vfit.ticketaid.services;
...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            // Save fragments to app state
            AppState.Country = address.getCountryName();
            AppState.City = address.getLocality();
            Log.i("Service", "City = "+address.getLocality());
